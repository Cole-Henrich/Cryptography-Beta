...
if(!SubstitutionCracker2.hasQ){
q_quit.close();
Scanner q_quarrels = new Scanner(SubstitutionCracker2.cipher);
while(q_quarrels.hasNext()){
String next = q_quarrels.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth},
new int[]{_u,_a,_r,_r,_e,_l,_s})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quarrels");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quarrels.close();
Scanner q_liquor = new Scanner(SubstitutionCracker2.cipher);
while(q_liquor.hasNext()){
String next = q_liquor.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_l,_i,_u,_o,_r})){
SubstitutionCracker2.key[_q] = third.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_liquor");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_liquor.close();
Scanner q_quickness = new Scanner(SubstitutionCracker2.cipher);
while(q_quickness.hasNext()){
String next = q_quickness.next();
if (next.length()==9){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth,ninth},
new int[]{_u,_i,_c,_k,_n,_e,_s,_s})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quickness");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_squeeze.close();
Scanner q_quiver = new Scanner(SubstitutionCracker2.cipher);
while(q_quiver.hasNext()){
String next = q_quiver.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_u,_i,_v,_e,_r})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quiver");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quiver.close();
Scanner q_quarreled = new Scanner(SubstitutionCracker2.cipher);
while(q_quarreled.hasNext()){
String next = q_quarreled.next();
if (next.length()==9){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth,ninth},
new int[]{_u,_a,_r,_r,_e,_l,_e,_d})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quarreled");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quarreled.close();
Scanner q_equity = new Scanner(SubstitutionCracker2.cipher);
while(q_equity.hasNext()){
String next = q_equity.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,third,fourth,fifth,sixth},
new int[]{_e,_u,_i,_t,_y})){
SubstitutionCracker2.key[_q] = second.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_equity");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_exquisite.close();
Scanner q_disquiet = new Scanner(SubstitutionCracker2.cipher);
while(q_disquiet.hasNext()){
String next = q_disquiet.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,second,third,fifth,sixth,seventh,eighth},
new int[]{_d,_i,_s,_u,_i,_e,_t})){
SubstitutionCracker2.key[_q] = fourth.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_disquiet");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_liquid.close();
Scanner q_quench = new Scanner(SubstitutionCracker2.cipher);
while(q_quench.hasNext()){
String next = q_quench.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth},
new int[]{_u,_e,_n,_c,_h})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quench");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quest.close();
Scanner q_requite = new Scanner(SubstitutionCracker2.cipher);
while(q_requite.hasNext()){
String next = q_requite.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth,seventh},
new int[]{_r,_e,_u,_i,_t,_e})){
SubstitutionCracker2.key[_q] = third.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_requite");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_queens.close();
Scanner q_quitted = new Scanner(SubstitutionCracker2.cipher);
while(q_quitted.hasNext()){
String next = q_quitted.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_u,_i,_t,_t,_e,_d})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quitted");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quitted.close();
Scanner q_quotation = new Scanner(SubstitutionCracker2.cipher);
while(q_quotation.hasNext()){
String next = q_quotation.next();
if (next.length()==9){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth,ninth},
new int[]{_u,_o,_t,_a,_t,_i,_o,_n})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quotation");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quotation.close();
Scanner q_quartered = new Scanner(SubstitutionCracker2.cipher);
while(q_quartered.hasNext()){
String next = q_quartered.next();
if (next.length()==9){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth,ninth},
new int[]{_u,_a,_r,_t,_e,_r,_e,_d})){
SubstitutionCracker2.key[_q] = first.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_quartered");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasQ){
q_quicker.close();
Scanner q_squealed = new Scanner(SubstitutionCracker2.cipher);
while(q_squealed.hasNext()){
String next = q_squealed.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,third,fourth,fifth,sixth,seventh,eighth},
new int[]{_s,_u,_e,_a,_l,_e,_d})){
SubstitutionCracker2.key[_q] = second.toLowerCase();
SubstitutionCracker2.hasQ=true;
System.err.println("SubstitutionCracker2.hasQ=true; via Scanner q_squealed");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
