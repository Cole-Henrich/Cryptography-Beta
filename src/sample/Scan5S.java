                                          ...
                                          while (s_hast.hasNext()) {
                                             ...
                                             if (next.length() == 4) {
                                                ...
                                                if (massCalc_notAnyOther(new String[] { first, second, fourth },
                                                   ...
                                                   SubstitutionCracker2.hasS = true;
                                                   System.err
                                                         .println("SubstitutionCracker2.hasS=true; via Scanner s_hast");
                                                   System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                         .replaceAll("null", "\u0000"));
                                                   System.err.println(SubstitutionCracker2.correctKey);
                                             ...
                                             while (s_saith.hasNext()) {
                                                ...
                                                if (next.length() == 5) {
                                                   ...
                                                   if (massCalc_notAnyOther(
                                                      ...
                                                      SubstitutionCracker2.hasS = true;
                                                      System.err.println(
                                                            "SubstitutionCracker2.hasS=true; via Scanner s_saith");
                                                      System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                            .replaceAll("null", "\u0000"));
                                                      System.err.println(SubstitutionCracker2.correctKey);
                                                ...
                                                while (s_set.hasNext()) {
                                                   ...
                                                   if (next.length() == 3) {
                                                      ...
                                                      if (massCalc_notAnyOther(new String[] { second, third },
                                                         ...
                                                         SubstitutionCracker2.hasS = true;
                                                         System.err.println(
                                                               "SubstitutionCracker2.hasS=true; via Scanner s_set");
                                                         System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                               .replaceAll("null", "\u0000"));
                                                         System.err.println(SubstitutionCracker2.correctKey);
                                                   ...
                                                   while (s_sent.hasNext()) {
                                                      ...
                                                      if (next.length() == 4) {
                                                         ...
                                                         if (massCalc_notAnyOther(
                                                            ...
                                                            SubstitutionCracker2.hasS = true;
                                                            System.err.println(
                                                                  "SubstitutionCracker2.hasS=true; via Scanner s_sent");
                                                            System.err
                                                         ...
                                                         if (next.length() == 4) {
                                                            ...
                                                            if (first.equalsIgnoreCase(fourth)) {
                                                               if (massCalc_notAnyOther(new String[] { second, third },
                                                                  ...
                                                                  SubstitutionCracker2.hasS = true;
                                                                  System.err.println(
                                                                        "SubstitutionCracker2.hasS=true; via Scanner s_sons");
                                                                  System.err.println(
                                                         ...
                                                         while (s_sat.hasNext()) {
                                                            ...
                                                            if (next.length() == 3) {
                                                               ...
                                                               if (massCalc_notAnyOther(new String[] { second, third },
                                                                  ...
                                                                  SubstitutionCracker2.hasS = true;
                                                                  System.err.println(
                                                                        "SubstitutionCracker2.hasS=true; via Scanner s_sat");
                                                                  System.err.println(
                                                                        (Arrays.toString(SubstitutionCracker2.key))
                                                                              .replaceAll("null", "\u0000"));
                                                                  System.err.println(SubstitutionCracker2.correctKey);
                                                            ...
                                                            while (s_seen.hasNext()) {
                                                               ...
                                                               if (next.length() == 4) {
                                                                  ...
                                                                  if (massCalc_notAnyOther(
                                                                     ...
                                                                     SubstitutionCracker2.hasS = true;
                                                                     System.err.println(
                                                                           "SubstitutionCracker2.hasS=true; via Scanner s_seen");
                                                                     System.err.println(
                                                                           (Arrays.toString(SubstitutionCracker2.key))
                                                                                 .replaceAll("null", "\u0000"));
                                                                     System.err
                                                                           .println(SubstitutionCracker2.correctKey);
                                                               ...
                                                               while (s_soon.hasNext()) {
                                                                  ...
                                                                  if (next.length() == 4) {
                                                                     ...
                                                                     if (massCalc_notAnyOther(
                                                                           new String[] { second, third, fourth },
                                                                           new int[] { _o, _o, _n })) {
                                                                        SubstitutionCracker2.key[_s] = first
                                                                              .toLowerCase();
                                                                        SubstitutionCracker2.hasS = true;
                                                                        System.err.println(
                                                                              "SubstitutionCracker2.hasS=true; via Scanner s_soon");
                                                                  ...
                                                                  while (s_sea.hasNext()) {
                                                                     ...
                                                                     if (next.length() == 3) {
                                                                        ...
                                                                        if (massCalc_notAnyOther(
                                                                           ...
                                                                           SubstitutionCracker2.hasS = true;
                                                                           System.err.println(
                                                                                 "SubstitutionCracker2.hasS=true; via Scanner s_sea");
                                                                           System.err.println((Arrays
                                                                                 .toString(SubstitutionCracker2.key))
                                                                                 .replaceAll("null", "\u0000"));
                                                                           System.err.println(
                                                                     ...
                                                                     while (s_state.hasNext()) {
                                                                        ...
                                                                        if (next.length() == 5) {
                                                                           ...
                                                                           if (massCalc_notAnyOther(
                                                                              ...
                                                                              SubstitutionCracker2.hasS = true;
                                                                              System.err.println(
                                                                                    "SubstitutionCracker2.hasS=true; via Scanner s_state");
                                                                              System.err.println((Arrays
                                                                                    .toString(SubstitutionCracker2.key))
                                                                                    .replaceAll("null", "\u0000"));
                                                                              System.err.println(
                                                                     ...
                                                                     if (!SubstitutionCracker2.hasS) {
                                                                        ...
                                                                        while (s_sit.hasNext()) {
                                                                           ...
                                                                           if (next.length() == 3) {
                                                                              ...
                                                                              if (massCalc_notAnyOther(
                                                                                 ...
                                                                                 SubstitutionCracker2.hasS = true;
                                                                                 System.err.println(
                                                                                       "SubstitutionCracker2.hasS=true; via Scanner s_sit");
                                                                        ...
                                                                        if (!SubstitutionCracker2.hasS) {
                                                                              ...
                                                                              if (next.length() == 7) {
                                                                                 ...
                                                                                 if (massCalc_notAnyOther(
                                                                                       new String[] { first, second,
                                                                                             third, fourth, fifth,
                                                                                             sixth },
                                                                                       new int[] { _n, _a, _t, _i, _o,
                                                                                             _n })) {
                                                                                    SubstitutionCracker2.key[_s] = seventh
                                                                                          .toLowerCase();
                                                                                    SubstitutionCracker2.hasS = true;
                                                                                    System.err.println(
                                                                                          "SubstitutionCracker2.hasS=true; via Scanner s_nations");
                                                                                    System.err.println((Arrays.toString(
                                                                                          SubstitutionCracker2.key))
                                                                                          .replaceAll("null",
                                                                                                "\u0000"));
                                                                           ...
                                                                           if (!SubstitutionCracker2.hasS) {
                                                                                 ...
                                                                                 if (next.length() == 5) {
                                                                                    ...
                                                                                    if (first
                                                                                       ...
                                                                                       if (massCalc_notAnyOther(
                                                                                          ...
                                                                                          SubstitutionCracker2.hasS = true;
                                                                                          System.err.println(
                                                                                                "SubstitutionCracker2.hasS=true; via Scanner s_sense");
                                                                                          System.err.println(
                                                                                                (Arrays.toString(
                                                                                                      SubstitutionCracker2.key))
                                                                                                      .replaceAll(
                                                                              ...
                                                                              if (!SubstitutionCracker2.hasS) {
                                                                                 s_sense.close();
                                                                                 Scanner s_sin = new Scanner(
                                                                                       SubstitutionCracker2.cipher);
                                                                                 while (s_sin.hasNext()) {
                                                                                    String next = s_sin.next();
                                                                                    if (next.length() == 3) {
                                                                                       String first = String
                                                                                             .valueOf(next.charAt(0));
                                                                                       String second = String
                                                                                       ...
                                                                                       if (massCalc_notAnyOther(
                                                                                          ...
                                                                                          SubstitutionCracker2.hasS = true;
                                                                                          System.err.println(
                                                                                                "SubstitutionCracker2.hasS=true; via Scanner s_sin");
                                                                                          System.err.println(
                                                                                                (Arrays.toString(
                                                                                                      SubstitutionCracker2.key))
                                                                                                      .replaceAll(
