...
public class AnagramSolverDeprecated {
    ...
    public AnagramSolverDeprecated(String letterset, double minimumFrequency) throws ManyCombinationsException, FileNotFoundException {
    ...
    public AnagramSolverDeprecated(String letterset) throws ManyCombinationsException, FileNotFoundException {
