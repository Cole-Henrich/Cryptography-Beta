...
if(!SubstitutionCracker2.hasP){
p_spent.close();
Scanner p_lips = new Scanner(SubstitutionCracker2.cipher);
while(p_lips.hasNext()){
String next = p_lips.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_p] = third.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_lips");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_steps.close();
Scanner p_pleased = new Scanner(SubstitutionCracker2.cipher);
while(p_pleased.hasNext()){
String next = p_pleased.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_l,_e,_a,_s,_e,_d})){
SubstitutionCracker2.key[_p] = first.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_pleased");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_political.close();
Scanner p_repeated = new Scanner(SubstitutionCracker2.cipher);
while(p_repeated.hasNext()){
String next = p_repeated.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth,seventh,eighth},
new int[]{_r,_e,_e,_a,_t,_e,_d})){
SubstitutionCracker2.key[_p] = third.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_repeated");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_company.close();
Scanner p_play = new Scanner(SubstitutionCracker2.cipher);
while(p_play.hasNext()){
String next = p_play.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_p] = first.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_play");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_simply.close();
Scanner p_dropped = new Scanner(SubstitutionCracker2.cipher);
while(p_dropped.hasNext()){
String next = p_dropped.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(fourth.equalsIgnoreCase(fifth)){
if(massCalc_notAnyOther(new String[]{first,second,third,sixth,seventh},
new int[]{_d,_r,_o,_e,_d})){
SubstitutionCracker2.key[_p] = fourth.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_dropped");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_dropped.close();
Scanner p_camp = new Scanner(SubstitutionCracker2.cipher);
while(p_camp.hasNext()){
String next = p_camp.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_p] = fourth.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_camp");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_camp.close();
Scanner p_sleep = new Scanner(SubstitutionCracker2.cipher);
...
SubstitutionCracker2.key[_p] = fifth.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_sleep");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasP){
p_sleep.close();
Scanner p_putting = new Scanner(SubstitutionCracker2.cipher);
while(p_putting.hasNext()){
String next = p_putting.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_u,_t,_t,_i,_n,_g})){
SubstitutionCracker2.key[_p] = first.toLowerCase();
SubstitutionCracker2.hasP=true;
System.err.println("SubstitutionCracker2.hasP=true; via Scanner p_putting");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
