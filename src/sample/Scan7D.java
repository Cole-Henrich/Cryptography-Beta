...
if(!SubstitutionCracker2.hasD){
d_entered.close();
Scanner d_seeds = new Scanner(SubstitutionCracker2.cipher);
while(d_seeds.hasNext()){
String next = d_seeds.next();
if (next.length()==5){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_d] = fourth.toLowerCase();
SubstitutionCracker2.hasD=true;
System.err.println("SubstitutionCracker2.hasD=true; via Scanner d_seeds");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasD){
d_raised.close();
Scanner d_idea = new Scanner(SubstitutionCracker2.cipher);
while(d_idea.hasNext()){
String next = d_idea.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_i,_e,_a})){
SubstitutionCracker2.key[_d] = second.toLowerCase();
SubstitutionCracker2.hasD=true;
System.err.println("SubstitutionCracker2.hasD=true; via Scanner d_idea");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
