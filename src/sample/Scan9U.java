...
if(!SubstitutionCracker2.hasU){
u_trust.close();
Scanner u_thousands = new Scanner(SubstitutionCracker2.cipher);
while(u_thousands.hasNext()){
String next = u_thousands.next();
if (next.length()==9){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_t,_h,_o,_s,_a,_n,_d,_s})){
if (notAnotherVowel(fourth,_u)){
SubstitutionCracker2.key[_u] = fourth.toLowerCase();
SubstitutionCracker2.hasU=true;
System.err.println("SubstitutionCracker2.hasU=true; via Scanner u_thousands");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasU){
u_unless.close();
Scanner u_due = new Scanner(SubstitutionCracker2.cipher);
while(u_due.hasNext()){
String next = u_due.next();
if (next.length()==3){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_u] = second.toLowerCase();
SubstitutionCracker2.hasU=true;
System.err.println("SubstitutionCracker2.hasU=true; via Scanner u_due");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
