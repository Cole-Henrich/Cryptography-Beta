...
public class Scan11C{
    ...
    public Scan11C(){
        System.err.println("new Scan11C");
                                                                    ...
                                                                    if(!SubstitutionCracker2.hasC){
                                                                        ...
                                                                        if(!SubstitutionCracker2.hasC){
                                                                            ...
                                                                            if(!SubstitutionCracker2.hasC){
                                                                                ...
                                                                                if(!SubstitutionCracker2.hasC){
                                                                                    c_care.close();
                                                                                    Scanner c_orchid = new Scanner(SubstitutionCracker2.cipher);
                                                                                    while(c_orchid.hasNext()){
                                                                                        String next = c_orchid.next();
                                                                                        if (next.length()==6){
                                                                                            String first = String.valueOf(next.charAt(0));
                                                                                            String second = String.valueOf(next.charAt(1));
                                                                                            String third = String.valueOf(next.charAt(2));
                                                                                            ...
                                                                                            if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth},
                                                                                                    new int[]{_o,_r,_h,_i,_d})){
                                                                                                SubstitutionCracker2.key[_c] = third.toLowerCase();
                                                                                                SubstitutionCracker2.hasC=true;
                                                                                                System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_orchid");
                                                                                                System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                System.err.println(SubstitutionCracker2.correctKey);
                                                                                                ...
                                                                                                if(!SubstitutionCracker2.hasC){
                                                                                                    ...
                                                                                                    if(!SubstitutionCracker2.hasC){
                                                                                                        ...
                                                                                                        if(!SubstitutionCracker2.hasC){
                                                                                                            ...
                                                                                                            if(!SubstitutionCracker2.hasC){
                                                                                                                c_carried.close();
                                                                                                                Scanner c_america = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                while(c_america.hasNext()){
                                                                                                                    String next = c_america.next();
                                                                                                                    if (next.length()==7){
                                                                                                                        String first = String.valueOf(next.charAt(0));
                                                                                                                        String second = String.valueOf(next.charAt(1));
                                                                                                                        String third = String.valueOf(next.charAt(2));
                                                                                                                        ...
                                                                                                                        if(massCalc_notAnyOther(new String[]{first,second,third,fourth,fifth,seventh},
                                                                                                                                new int[]{_a,_m,_e,_r,_i,_a})){
                                                                                                                            SubstitutionCracker2.key[_c] = sixth.toLowerCase();
                                                                                                                            SubstitutionCracker2.hasC=true;
                                                                                                                            System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_america");
                                                                                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                            System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                ...
                                                                                                                if(!SubstitutionCracker2.hasC){
                                                                                                                    ...
                                                                                                                    if(!SubstitutionCracker2.hasC){
                                                                                                                        c_nicholas.close();
                                                                                                                        Scanner c_orchids = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                        while(c_orchids.hasNext()){
                                                                                                                            String next = c_orchids.next();
                                                                                                                            if (next.length()==7){
                                                                                                                                String first = String.valueOf(next.charAt(0));
                                                                                                                                String second = String.valueOf(next.charAt(1));
                                                                                                                                String third = String.valueOf(next.charAt(2));
                                                                                                                                ...
                                                                                                                                if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth,seventh},
                                                                                                                                        new int[]{_o,_r,_h,_i,_d,_s})){
                                                                                                                                    SubstitutionCracker2.key[_c] = third.toLowerCase();
                                                                                                                                    SubstitutionCracker2.hasC=true;
                                                                                                                                    System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_orchids");
                                                                                                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                    System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                    ...
                                                                                                                                                                    if(!SubstitutionCracker2.hasC){
                                                                                                                                                                        ...
                                                                                                                                                                        if(!SubstitutionCracker2.hasC){
                                                                                                                                                                            ...
                                                                                                                                                                            if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                ...
                                                                                                                                                                                if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                    c_decided.close();
                                                                                                                                                                                    Scanner c_economic = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                    while(c_economic.hasNext()){
                                                                                                                                                                                        String next = c_economic.next();
                                                                                                                                                                                        if (next.length()==8){
                                                                                                                                                                                            String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                            String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                            String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                            ...
                                                                                                                                                                                            if(second.equalsIgnoreCase(eighth)){
                                                                                                                                                                                                if(massCalc_notAnyOther(new String[]{first,third,fourth,fifth,sixth,seventh},
                                                                                                                                                                                                        new int[]{_e,_o,_n,_o,_m,_i})){
                                                                                                                                                                                                    SubstitutionCracker2.key[_c] = second.toLowerCase();
                                                                                                                                                                                                    SubstitutionCracker2.hasC=true;
                                                                                                                                                                                                    System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_economic");
                                                                                                                                                                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                    System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                    ...
                                                                                                                                                                                    if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                        ...
                                                                                                                                                                                        if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                            c_cold.close();
                                                                                                                                                                                            Scanner c_comes = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                            while(c_comes.hasNext()){
                                                                                                                                                                                                String next = c_comes.next();
                                                                                                                                                                                                if (next.length()==5){
                                                                                                                                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth},
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        SubstitutionCracker2.key[_c] = first.toLowerCase();
                                                                                                                                                                                                        SubstitutionCracker2.hasC=true;
                                                                                                                                                                                                        System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_comes");
                                                                                                                                                                                                        System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                        System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                            ...
                                                                                                                                                                                            if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                                c_comes.close();
                                                                                                                                                                                                Scanner c_act = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                while(c_act.hasNext()){
                                                                                                                                                                                                    String next = c_act.next();
                                                                                                                                                                                                    if (next.length()==3){
                                                                                                                                                                                                        String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                        String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                        String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if(massCalc_notAnyOther(new String[]{first,third},
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            SubstitutionCracker2.key[_c] = second.toLowerCase();
                                                                                                                                                                                                            SubstitutionCracker2.hasC=true;
                                                                                                                                                                                                            System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_act");
                                                                                                                                                                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                            System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                                ...
                                                                                                                                                                                                if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                                    c_act.close();
                                                                                                                                                                                                    Scanner c_americans = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                    while(c_americans.hasNext()){
                                                                                                                                                                                                        String next = c_americans.next();
                                                                                                                                                                                                        if (next.length()==9){
                                                                                                                                                                                                            String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                            String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                            String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if(massCalc_notAnyOther(new String[]{first,second,third,fourth,fifth,seventh,eighth,ninth},
                                                                                                                                                                                                                    new int[]{_a,_m,_e,_r,_i,_a,_n,_s})){
                                                                                                                                                                                                                SubstitutionCracker2.key[_c] = sixth.toLowerCase();
                                                                                                                                                                                                                SubstitutionCracker2.hasC=true;
                                                                                                                                                                                                                System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_americans");
                                                                                                                                                                                                                System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                                System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if(!SubstitutionCracker2.hasC){
                                                                                                                                                                                                            c_noticed.close();
                                                                                                                                                                                                            Scanner c_school = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                            while(c_school.hasNext()){
                                                                                                                                                                                                                String next = c_school.next();
                                                                                                                                                                                                                if (next.length()==6){
                                                                                                                                                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if(massCalc_notAnyOther(new String[]{first,third,fourth,fifth,sixth},
                                                                                                                                                                                                                            new int[]{_s,_h,_o,_o,_l})){
                                                                                                                                                                                                                        SubstitutionCracker2.key[_c] = second.toLowerCase();
                                                                                                                                                                                                                        SubstitutionCracker2.hasC=true;
                                                                                                                                                                                                                        System.err.println("SubstitutionCracker2.hasC=true; via Scanner c_school");
                                                                                                                                                                                                                        System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                                        System.err.println(SubstitutionCracker2.correctKey);
