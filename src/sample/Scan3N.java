                                       ...
                                       while (n_tone.hasNext()) {
                                          ...
                                          if (next.length() == 4) {
                                             ...
                                             if (massCalc_notAnyOther(new String[] { first, second, fourth },
                                                ...
                                                SubstitutionCracker2.hasN = true;
                                                System.err
                                                      .println("SubstitutionCracker2.hasN=true; via Scanner n_tone");
                                                System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                      .replaceAll("null", "\u0000"));
                                                System.err.println(SubstitutionCracker2.correctKey);
                                          ...
                                          while (n_eaten.hasNext()) {
                                             ...
                                             if (next.length() == 5) {
                                                ...
                                                if (massCalc_notAnyOther(new String[] { first, second, third, fourth },
                                                   ...
                                                   SubstitutionCracker2.hasN = true;
                                                   System.err.println(
                                                         "SubstitutionCracker2.hasN=true; via Scanner n_eaten");
                                                   System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                         .replaceAll("null", "\u0000"));
                                                   System.err.println(SubstitutionCracker2.correctKey);
                                             ...
                                             while (n_note.hasNext()) {
                                                ...
                                                if (next.length() == 4) {
                                                   ...
                                                   if (massCalc_notAnyOther(new String[] { second, third, fourth },
                                                      ...
                                                      SubstitutionCracker2.hasN = true;
                                                      System.err.println(
                                                            "SubstitutionCracker2.hasN=true; via Scanner n_note");
                                                      System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                            .replaceAll("null", "\u0000"));
                                                      System.err.println(SubstitutionCracker2.correctKey);
                                                ...
                                                while (n_tenth.hasNext()) {
                                                   ...
                                                   if (next.length() == 5) {
                                                      ...
                                                      if (massCalc_notAnyOther(
                                                         ...
                                                         SubstitutionCracker2.hasN = true;
                                                         System.err.println(
                                                               "SubstitutionCracker2.hasN=true; via Scanner n_tenth");
                                                         System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                               .replaceAll("null", "\u0000"));
                                                         System.err.println(SubstitutionCracker2.correctKey);
                                                   ...
                                                   while (n_tent.hasNext()) {
                                                      ...
                                                      if (next.length() == 4) {
                                                         ...
                                                         if (massCalc_notAnyOther(
                                                            ...
                                                            SubstitutionCracker2.hasN = true;
                                                            System.err.println(
                                                                  "SubstitutionCracker2.hasN=true; via Scanner n_tent");
                                                            System.err
                                                      ...
                                                      while (n_net.hasNext()) {
                                                         ...
                                                         if (next.length() == 3) {
                                                            ...
                                                            if (massCalc_notAnyOther(new String[] { second, third },
                                                               ...
                                                               SubstitutionCracker2.hasN = true;
                                                               System.err.println(
                                                                     "SubstitutionCracker2.hasN=true; via Scanner n_net");
                                                               System.err.println(
                                                            ...
                                                            if (next.length() == 6) {
                                                               ...
                                                               if (first.equalsIgnoreCase(sixth)) {
                                                                  if (massCalc_notAnyOther(
                                                                     ...
                                                                     SubstitutionCracker2.hasN = true;
                                                                     System.err.println(
                                                                           "SubstitutionCracker2.hasN=true; via Scanner n_nathan");
                                                                     System.err.println(
                                                                           (Arrays.toString(SubstitutionCracker2.key))
                                                                                 .replaceAll("null", "\u0000"));
                                                                     System.err
