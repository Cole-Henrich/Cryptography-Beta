...
public class Scan12F{
    ...
    public Scan12F(){
        System.err.println("new Scan12F");
                ...
                if(!SubstitutionCracker2.hasF){
                    ...
                    if(!SubstitutionCracker2.hasF){
                        ...
                        if(!SubstitutionCracker2.hasF){
                            ...
                            if(!SubstitutionCracker2.hasF){
                                f_first.close();
                                Scanner f_face = new Scanner(SubstitutionCracker2.cipher);
                                while(f_face.hasNext()){
                                    String next = f_face.next();
                                    if (next.length()==4){
                                        String first = String.valueOf(next.charAt(0));
                                        String second = String.valueOf(next.charAt(1));
                                        String third = String.valueOf(next.charAt(2));
                                        ...
                                        if(massCalc_notAnyOther(new String[]{second,third,fourth},
                                            ...
                                            SubstitutionCracker2.key[_f] = first.toLowerCase();
                                            SubstitutionCracker2.hasF=true;
                                            System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_face");
                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                            System.err.println(SubstitutionCracker2.correctKey);
                                                            ...
                                                            if(!SubstitutionCracker2.hasF){
                                                                ...
                                                                if(!SubstitutionCracker2.hasF){
                                                                    ...
                                                                    if(!SubstitutionCracker2.hasF){
                                                                        ...
                                                                        if(!SubstitutionCracker2.hasF){
                                                                            f_forth.close();
                                                                            Scanner f_french = new Scanner(SubstitutionCracker2.cipher);
                                                                            while(f_french.hasNext()){
                                                                                String next = f_french.next();
                                                                                if (next.length()==6){
                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                    ...
                                                                                    if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth},
                                                                                            new int[]{_r,_e,_n,_c,_h})){
                                                                                        SubstitutionCracker2.key[_f] = first.toLowerCase();
                                                                                        SubstitutionCracker2.hasF=true;
                                                                                        System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_french");
                                                                                        System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                        System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                    ...
                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                        ...
                                                                                                                        if(!SubstitutionCracker2.hasF){
                                                                                                                            ...
                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                ...
                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                    f_filled.close();
                                                                                                                                    Scanner f_chief = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                    while(f_chief.hasNext()){
                                                                                                                                        String next = f_chief.next();
                                                                                                                                        if (next.length()==5){
                                                                                                                                            String first = String.valueOf(next.charAt(0));
                                                                                                                                            String second = String.valueOf(next.charAt(1));
                                                                                                                                            String third = String.valueOf(next.charAt(2));
                                                                                                                                            ...
                                                                                                                                            if(massCalc_notAnyOther(new String[]{first,second,third,fourth},
                                                                                                                                                    new int[]{_c,_h,_i,_e})){
                                                                                                                                                SubstitutionCracker2.key[_f] = fifth.toLowerCase();
                                                                                                                                                SubstitutionCracker2.hasF=true;
                                                                                                                                                System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_chief");
                                                                                                                                                System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                        ...
                                                                                                                                        if(!SubstitutionCracker2.hasF){
                                                                                                                                            ...
                                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                                ...
                                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                                    ...
                                                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                                                        f_herself.close();
                                                                                                                                                        Scanner f_fact = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                        while(f_fact.hasNext()){
                                                                                                                                                            String next = f_fact.next();
                                                                                                                                                            if (next.length()==4){
                                                                                                                                                                String first = String.valueOf(next.charAt(0));
                                                                                                                                                                String second = String.valueOf(next.charAt(1));
                                                                                                                                                                String third = String.valueOf(next.charAt(2));
                                                                                                                                                                ...
                                                                                                                                                                if(massCalc_notAnyOther(new String[]{second,third,fourth},
                                                                                                                                                                    ...
                                                                                                                                                                    SubstitutionCracker2.key[_f] = first.toLowerCase();
                                                                                                                                                                    SubstitutionCracker2.hasF=true;
                                                                                                                                                                    System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_fact");
                                                                                                                                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                    System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                            ...
                                                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                                                ...
                                                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                                                    ...
                                                                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                                                                        ...
                                                                                                                                                                        if(!SubstitutionCracker2.hasF){
                                                                                                                                                                            f_itself.close();
                                                                                                                                                                            Scanner f_officer = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                            while(f_officer.hasNext()){
                                                                                                                                                                                String next = f_officer.next();
                                                                                                                                                                                if (next.length()==7){
                                                                                                                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                    ...
                                                                                                                                                                                    if(second.equalsIgnoreCase(third)){
                                                                                                                                                                                        if(massCalc_notAnyOther(new String[]{first,fourth,fifth,sixth,seventh},
                                                                                                                                                                                                new int[]{_o,_i,_c,_e,_r})){
                                                                                                                                                                                            SubstitutionCracker2.key[_f] = second.toLowerCase();
                                                                                                                                                                                            SubstitutionCracker2.hasF=true;
                                                                                                                                                                                            System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_officer");
                                                                                                                                                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                            System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                            ...
                                                                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                ...
                                                                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                    ...
                                                                                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                        ...
                                                                                                                                                                                        if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                            f_freedom.close();
                                                                                                                                                                                            Scanner f_force = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                            while(f_force.hasNext()){
                                                                                                                                                                                                String next = f_force.next();
                                                                                                                                                                                                if (next.length()==5){
                                                                                                                                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth},
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        SubstitutionCracker2.key[_f] = first.toLowerCase();
                                                                                                                                                                                                        SubstitutionCracker2.hasF=true;
                                                                                                                                                                                                        System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_force");
                                                                                                                                                                                                        System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                        System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                            ...
                                                                                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                ...
                                                                                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                    f_former.close();
                                                                                                                                                                                                    Scanner f_sacrifice = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                    while(f_sacrifice.hasNext()){
                                                                                                                                                                                                        String next = f_sacrifice.next();
                                                                                                                                                                                                        if (next.length()==9){
                                                                                                                                                                                                            String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                            String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                            String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if(massCalc_notAnyOther(new String[]{first,second,third,fourth,fifth,seventh,eighth,ninth},
                                                                                                                                                                                                                    new int[]{_s,_a,_c,_r,_i,_i,_c,_e})){
                                                                                                                                                                                                                SubstitutionCracker2.key[_f] = sixth.toLowerCase();
                                                                                                                                                                                                                SubstitutionCracker2.hasF=true;
                                                                                                                                                                                                                System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_sacrifice");
                                                                                                                                                                                                                System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                                System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                            f_fine.close();
                                                                                                                                                                                                            Scanner f_difficult = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                            while(f_difficult.hasNext()){
                                                                                                                                                                                                                String next = f_difficult.next();
                                                                                                                                                                                                                if (next.length()==9){
                                                                                                                                                                                                                    String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                                    String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                                    String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if(third.equalsIgnoreCase(fourth)){
                                                                                                                                                                                                                        if(massCalc_notAnyOther(new String[]{first,second,fifth,sixth,seventh,eighth,ninth},
                                                                                                                                                                                                                                new int[]{_d,_i,_i,_c,_u,_l,_t})){
                                                                                                                                                                                                                            SubstitutionCracker2.key[_f] = third.toLowerCase();
                                                                                                                                                                                                                            SubstitutionCracker2.hasF=true;
                                                                                                                                                                                                                            System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_difficult");
                                                                                                                                                                                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                                            System.err.println(SubstitutionCracker2.correctKey);
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if(!SubstitutionCracker2.hasF){
                                                                                                                                                                                                                        f_flesh.close();
                                                                                                                                                                                                                        Scanner f_future = new Scanner(SubstitutionCracker2.cipher);
                                                                                                                                                                                                                        while(f_future.hasNext()){
                                                                                                                                                                                                                            String next = f_future.next();
                                                                                                                                                                                                                            if (next.length()==6){
                                                                                                                                                                                                                                String first = String.valueOf(next.charAt(0));
                                                                                                                                                                                                                                String second = String.valueOf(next.charAt(1));
                                                                                                                                                                                                                                String third = String.valueOf(next.charAt(2));
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth},
                                                                                                                                                                                                                                        new int[]{_u,_t,_u,_r,_e})){
                                                                                                                                                                                                                                    SubstitutionCracker2.key[_f] = first.toLowerCase();
                                                                                                                                                                                                                                    SubstitutionCracker2.hasF=true;
                                                                                                                                                                                                                                    System.err.println("SubstitutionCracker2.hasF=true; via Scanner f_future");
                                                                                                                                                                                                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                                                                                                                                                                                                    System.err.println(SubstitutionCracker2.correctKey);
