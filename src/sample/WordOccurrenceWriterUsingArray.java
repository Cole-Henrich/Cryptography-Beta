...
//        System.out.println(got.get(b.get(0).getIndex()) + " "+ b.get(0).getOccurrences());
    ...
    public static void main(String[] args) throws IOException {
        ...
        File[] WordAndOccurrenceStoresUsingArrays = new File[]{
                new File("sample/WordAndOccurrenceStoreArray1.java"),
                new File("sample/WordAndOccurrenceStoreArray2.java"),
                new File("sample/WordAndOccurrenceStoreArray3.java"),
                new File("sample/WordAndOccurrenceStoreArray4.java"),
                new File("sample/WordAndOccurrenceStoreArray5.java"),
                new File("sample/WordAndOccurrenceStoreArray6.java"),
                new File("sample/WordAndOccurrenceStoreArray7.java"),
                new File("sample/WordAndOccurrenceStoreArray8.java"),
                new File("sample/WordAndOccurrenceStoreArray9.java"),
                new File("sample/WordAndOccurrenceStoreArray10.java"),
                new File("sample/WordAndOccurrenceStoreArray11.java"),
                new File("sample/WordAndOccurrenceStoreArray12.java"),
                new File("sample/WordAndOccurrenceStoreArray13.java"),
                new File("sample/WordAndOccurrenceStoreArray14.java"),
                new File("sample/WordAndOccurrenceStoreArray15.java"),
                new File("sample/WordAndOccurrenceStoreArray16.java"),
                new File("sample/WordAndOccurrenceStoreArray17.java"),
                new File("sample/WordAndOccurrenceStoreArray18.java"),
                new File("sample/WordAndOccurrenceStoreArray19.java"),
                new File("sample/WordAndOccurrenceStoreArray20.java"),
                new File("sample/WordAndOccurrenceStoreArray21.java"),
                new File("sample/WordAndOccurrenceStoreArray22.java"),
                new File("sample/WordAndOccurrenceStoreArray23.java")
        };
        File BigWordAndOccurrenceStoreArray = new File("sample/BigWordAndOccurrenceStoreArray.java");
        Time time = new Time();
