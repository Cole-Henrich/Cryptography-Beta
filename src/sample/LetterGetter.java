...
//                                System.err.println(count);
    ...
    public LetterGetter(String Letter) throws FileNotFoundException {
        this(Letter, new File("sample/Language_Manipulation_Unique-Words_Trainer-Reservoir.txt"));
    }
    ...
    public LetterGetter(String Letter, String[] notContains) throws FileNotFoundException {
        this(new File("sample/Language_Manipulation_Unique-Words_Trainer-Reservoir.txt"), notContains, Letter, 10, true, new String[]{""});
    }
    public LetterGetter(String Letter, String[] notContains, int topWhat_egTopTen) throws FileNotFoundException {
        this(new File("sample/Language_Manipulation_Unique-Words_Trainer-Reservoir.txt"), notContains, Letter, topWhat_egTopTen, true, new String[]{""});
    }
    public LetterGetter(String letter, String[] contains, int topWhat_egTopTen, boolean containsEqualsNotContains) throws FileNotFoundException {
        this(new File("sample/Language_Manipulation_Unique-Words_Trainer-Reservoir.txt"),new Metamorphose().reverseContains(contains), letter, topWhat_egTopTen, false, new String[]{""});
    }
