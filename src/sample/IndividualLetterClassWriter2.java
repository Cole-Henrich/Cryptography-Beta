...
public class IndividualLetterClassWriter2 {
    private final CharSet charSet = new CharSet();
    private final File[] Files = new File[]{
            new File("src/sample/Scan1E.java"),
            new File("src/sample/Scan2O.java"),
            new File("src/sample/Scan3N.java"),
            new File("src/sample/Scan4I.java"),
            new File("src/sample/Scan5S.java"),
            new File("src/sample/Scan6R.java"),
            new File("src/sample/Scan7D.java"),
            new File("src/sample/Scan8L.java"),
            new File("src/sample/Scan9U.java"),
            new File("src/sample/Scan10M.java"),
            new File("src/sample/Scan11C.java"),
            new File("src/sample/Scan12F.java"),
            new File("src/sample/Scan13W.java"),
            new File("src/sample/Scan14G.java"),
            new File("src/sample/Scan15Y.java"),
            new File("src/sample/Scan16P.java"),
            new File("src/sample/Scan17B.java"),
            new File("src/sample/Scan18V.java"),
            new File("src/sample/Scan19K.java"),
            new File("src/sample/Scan20J.java"),
            new File("src/sample/Scan21X.java"),
            new File("src/sample/Scan22Z.java"),
            new File("src/sample/Scan23Q.java"),
    };
    public IndividualLetterClassWriter2(int numLoopsBaseline, int increment) throws IOException {
        etao ETAO = new etao();
        ...
        int FileIndex = 0;
        LetterGetter[] mostCommonOfEachLetter = new LetterGetter[Etao.length()];
        while (Etao.length() > 0) {
            ...
            mostCommonOfEachLetter[FileIndex]=letterGetter;
...
//            numLoopsBaseline += increment;
        ...
        for (int i = 0; i < mostCommonOfEachLetter.length; i++) {
            LetterGetter letterGetter = mostCommonOfEachLetter[i];
            String Letter = letterGetter.getLetter();
            String[] mostCommon = letterGetter.getMostCommon_mostCommonFIRST();
            ArrayList<String> b = new ArrayList<>(Arrays.asList(mostCommon));
            for (int j = 0; j < mostCommonOfEachLetter.length; j++) {
                LetterGetter letterGetter2 = mostCommonOfEachLetter[j];
                String Letter2 = letterGetter2.getLetter();
                String[] mostCommon2 = letterGetter2.getMostCommon_mostCommonFIRST();
//                ArrayList<String> b = new ArrayList<>(Arrays.asList(mostCommon2));
            }
        }
...
//        ArrayList<ArrayList<String>> MostCommonOfEachLetter = new ArrayList<>();
//        for (String[] a:mostCommonOfEachLetter){
//            ArrayList<String> b = new ArrayList<>(Arrays.asList(a));
//            MostCommonOfEachLetter.add(b);
//        }
//        for (ArrayList<String> a:MostCommonOfEachLetter){
//            for (String b:a){
//                for(String c:a){
//                    if (!b.equals(c)){
