...
//                        new int[]{_t,_h})){
                if (first.equalsIgnoreCase(SubstitutionCracker2.key[_t]) && second.equalsIgnoreCase(SubstitutionCracker2.key[_h])){
//                    if (notAnotherVowel(third,_e)){
                                        ...
                                        if (next.length()==4){
                                            ...
                                            if(massCalc_notAnyOther(new String[]{first,third,fourth},
                                                ...
                                                if (notAnotherVowel(second,_e)){
                                                    SubstitutionCracker2.key[_e] = second.toLowerCase();
                                                    SubstitutionCracker2.hasE=true;
                                                    System.err.println("SubstitutionCracker2.hasE=true; via Scanner e_heat");
                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                    System.err.println(SubstitutionCracker2.correctKey);
                                                ...
                                                if(second.equalsIgnoreCase(third)){
                                                    if(massCalc_notAnyOther(new String[]{first,fourth,fifth},
                                                        ...
                                                        if (notAnotherVowel(second,_e)){
                                                            SubstitutionCracker2.key[_e] = second.toLowerCase();
                                                            SubstitutionCracker2.hasE=true;
                                                            System.err.println("SubstitutionCracker2.hasE=true; via Scanner e_teeth");
                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                            System.err.println(SubstitutionCracker2.correctKey);
                                                ...
                                                if (next.length()==3){
                                                    ...
                                                    if(massCalc_notAnyOther(new String[]{first,third},
                                                        ...
                                                        if (notAnotherVowel(second,_e)){
                                                            SubstitutionCracker2.key[_e] = second.toLowerCase();
                                                            SubstitutionCracker2.hasE=true;
                                                            System.err.println("SubstitutionCracker2.hasE=true; via Scanner e_tea");
                                                            System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
                                                            System.err.println(SubstitutionCracker2.correctKey);
