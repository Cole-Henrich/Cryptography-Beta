...
public class _1231sThatExistInText {
    ...
    public _1231sThatExistInText(String Text, boolean General) throws IOException {
        ...
        text = Text;
        if (general){
            File mutableCopyFile = new File("sample/MUTABLE_VERSIONOfLanguageManipulationReservoirForOptimizingSpeeds");
            ...
            println();
            File unrelatedLongData = new File("sample/dataLongs");
