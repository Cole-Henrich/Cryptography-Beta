...
if(!SubstitutionCracker2.hasJ){
j_jungle.close();
Scanner j_january = new Scanner(SubstitutionCracker2.cipher);
while(j_january.hasNext()){
String next = j_january.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_a,_n,_u,_a,_r,_y})){
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_january");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_january.close();
Scanner j_july = new Scanner(SubstitutionCracker2.cipher);
while(j_july.hasNext()){
String next = j_july.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_july");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_justified.close();
Scanner j_jewel = new Scanner(SubstitutionCracker2.cipher);
while(j_jewel.hasNext()){
String next = j_jewel.next();
if (next.length()==5){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_jewel");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_jump.close();
Scanner j_joint = new Scanner(SubstitutionCracker2.cipher);
while(j_joint.hasNext()){
String next = j_joint.next();
if (next.length()==5){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_joint");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_judging.close();
Scanner j_jewish = new Scanner(SubstitutionCracker2.cipher);
while(j_jewish.hasNext()){
String next = j_jewish.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth},
new int[]{_e,_w,_i,_s,_h})){
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_jewish");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_judea.close();
Scanner j_jim = new Scanner(SubstitutionCracker2.cipher);
while(j_jim.hasNext()){
String next = j_jim.next();
if (next.length()==3){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_jim");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_joyous.close();
Scanner j_journal = new Scanner(SubstitutionCracker2.cipher);
while(j_journal.hasNext()){
String next = j_journal.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_o,_u,_r,_n,_a,_l})){
SubstitutionCracker2.key[_j] = first.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_journal");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_jericho.close();
Scanner j_reject = new Scanner(SubstitutionCracker2.cipher);
while(j_reject.hasNext()){
String next = j_reject.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth},
new int[]{_r,_e,_e,_c,_t})){
SubstitutionCracker2.key[_j] = third.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_reject");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasJ){
j_reject.close();
Scanner j_adjust = new Scanner(SubstitutionCracker2.cipher);
while(j_adjust.hasNext()){
String next = j_adjust.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{first,second,fourth,fifth,sixth},
new int[]{_a,_d,_u,_s,_t})){
SubstitutionCracker2.key[_j] = third.toLowerCase();
SubstitutionCracker2.hasJ=true;
System.err.println("SubstitutionCracker2.hasJ=true; via Scanner j_adjust");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
