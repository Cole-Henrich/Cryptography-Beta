...
if(!SubstitutionCracker2.hasW){
w_follow.close();
Scanner w_forward = new Scanner(SubstitutionCracker2.cipher);
while(w_forward.hasNext()){
String next = w_forward.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_f,_o,_r,_a,_r,_d})){
SubstitutionCracker2.key[_w] = fourth.toLowerCase();
SubstitutionCracker2.hasW=true;
System.err.println("SubstitutionCracker2.hasW=true; via Scanner w_forward");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasW){
w_dwelt.close();
Scanner w_news = new Scanner(SubstitutionCracker2.cipher);
while(w_news.hasNext()){
String next = w_news.next();
if (next.length()==4){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_w] = third.toLowerCase();
SubstitutionCracker2.hasW=true;
System.err.println("SubstitutionCracker2.hasW=true; via Scanner w_news");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
