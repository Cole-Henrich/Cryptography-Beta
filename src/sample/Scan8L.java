...
if(!SubstitutionCracker2.hasL){
l_held.close();
Scanner l_health = new Scanner(SubstitutionCracker2.cipher);
while(l_health.hasNext()){
String next = l_health.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_h,_e,_a,_t,_h})){
SubstitutionCracker2.key[_l] = fourth.toLowerCase();
SubstitutionCracker2.hasL=true;
System.err.println("SubstitutionCracker2.hasL=true; via Scanner l_health");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasL){
l_letter.close();
Scanner l_national = new Scanner(SubstitutionCracker2.cipher);
while(l_national.hasNext()){
String next = l_national.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_n,_a,_t,_i,_o,_n,_a})){
SubstitutionCracker2.key[_l] = eighth.toLowerCase();
SubstitutionCracker2.hasL=true;
System.err.println("SubstitutionCracker2.hasL=true; via Scanner l_national");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasL){
l_line.close();
Scanner l_learn = new Scanner(SubstitutionCracker2.cipher);
...
SubstitutionCracker2.key[_l] = first.toLowerCase();
SubstitutionCracker2.hasL=true;
System.err.println("SubstitutionCracker2.hasL=true; via Scanner l_learn");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
