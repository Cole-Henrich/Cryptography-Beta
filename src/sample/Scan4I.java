                        ...
                        while (i_attention.hasNext()) {
                            ...
                            if (next.length() == 9) {
                                ...
                                if (massCalc_notAnyOther(
                                        new String[] { first, second, third, fourth, fifth, sixth, eighth, ninth },
                                    ...
                                    if (next.length() == 4) {
                                        ...
                                        if (massCalc_notAnyOther(new String[] { first, third, fourth },
                                            ...
                                            if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                ...
                                                SubstitutionCracker2.hasI = true;
                                                System.err
                                                        .println("SubstitutionCracker2.hasI=true; via Scanner i_nine");
                                                System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                        .replaceAll("null", "\u0000"));
                                                System.err.println(SubstitutionCracker2.correctKey);
                                        ...
                                        if (next.length() == 3) {
                                            ...
                                            if (massCalc_notAnyOther(new String[] { first, third },
                                                ...
                                                if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                    ...
                                                    SubstitutionCracker2.hasI = true;
                                                    System.err.println(
                                                            "SubstitutionCracker2.hasI=true; via Scanner i_hit");
                                                    System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                            .replaceAll("null", "\u0000"));
                                                    System.err.println(SubstitutionCracker2.correctKey);
                                            ...
                                            if (next.length() == 6) {
                                                ...
                                                if (massCalc_notAnyOther(
                                                    ...
                                                    if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                        ...
                                                        SubstitutionCracker2.hasI = true;
                                                        System.err.println(
                                                                "SubstitutionCracker2.hasI=true; via Scanner i_notion");
                                                        System.err.println((Arrays.toString(SubstitutionCracker2.key))
                                                                .replaceAll("null", "\u0000"));
                                                        System.err.println(SubstitutionCracker2.correctKey);
                                                    ...
                                                    if (first.equalsIgnoreCase(seventh)) {
                                                        if (massCalc_notAnyOther(
                                                            ...
                                                            if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                                ...
                                                                SubstitutionCracker2.hasI = true;
                                                                System.err.println(
                                                                        "SubstitutionCracker2.hasI=true; via Scanner i_intention");
                                                                System.err.println(
                                                    ...
                                                    if (next.length() == 4) {
                                                        ...
                                                        if (massCalc_notAnyOther(new String[] { first, third, fourth },
                                                            ...
                                                            if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                                ...
                                                                SubstitutionCracker2.hasI = true;
                                                                System.err.println(
                                                                        "SubstitutionCracker2.hasI=true; via Scanner i_tion");
                                                                System.err.println(
                                                                        (Arrays.toString(SubstitutionCracker2.key))
                                                                                .replaceAll("null", "\u0000"));
                                                                System.err.println(SubstitutionCracker2.correctKey);
                                                ...
                                                if (!SubstitutionCracker2.hasI) {
                                                        ...
                                                        if (next.length() == 5) {
                                                            ...
                                                            if (massCalc_notAnyOther(
                                                                ...
                                                                if (notAnotherVowel(SubstitutionCracker2.key[_i], _i)) {
                                                                    ...
                                                                    SubstitutionCracker2.hasI = true;
                                                                    System.err.println(
                                                                            "SubstitutionCracker2.hasI=true; via Scanner i_ninth");
                                                                    System.err.println(
                                                                            (Arrays.toString(SubstitutionCracker2.key))
                                                                                    .replaceAll("null", "\u0000"));
                                                                    System.err.println(SubstitutionCracker2.correctKey);
                                                    ...
                                                    if (!SubstitutionCracker2.hasI) {
                                                        ...
                                                        while (i_attain.hasNext()) {
                                                            ...
                                                            if (next.length() == 6) {
                                                                ...
                                                                if (massCalc_notAnyOther(
                                                                    ...
                                                                    if (notAnotherVowel(SubstitutionCracker2.key[_i],
                                                                            _i)) {
                                                                        SubstitutionCracker2.key[_i] = fifth
                                                                                .toLowerCase();
                                                                        SubstitutionCracker2.hasI = true;
                                                                        System.err.println(
                                                                                "SubstitutionCracker2.hasI=true; via Scanner i_attain");
                                                        ...
                                                        if (!SubstitutionCracker2.hasI) {
                                                            ...
                                                            while (i_tie.hasNext()) {
                                                                ...
                                                                if (next.length() == 3) {
                                                                    ...
                                                                    if (massCalc_notAnyOther(
                                                                            ...
                                                                            new int[] { _t, _e })) {
                                                                        if (notAnotherVowel(
                                                                                SubstitutionCracker2.key[_i], _i)) {
                                                                            SubstitutionCracker2.key[_i] = second
                                                                                    .toLowerCase();
                                                                            SubstitutionCracker2.hasI = true;
                                                                            System.err.println(
                                                                                    "SubstitutionCracker2.hasI=true; via Scanner i_tie");
                                                                            System.err.println((Arrays
                                                                                    .toString(SubstitutionCracker2.key))
                                                                                    .replaceAll("null", "\u0000"));
                                                                            System.err.println(
                                                            ...
                                                            if (!SubstitutionCracker2.hasI) {
                                                                i_tie.close();
                                                                Scanner i_thine = new Scanner(
                                                                        SubstitutionCracker2.cipher);
                                                                while (i_thine.hasNext()) {
                                                                    ...
                                                                    if (next.length() == 5) {
                                                                        ...
                                                                        if (massCalc_notAnyOther(
                                                                            ...
                                                                            if (notAnotherVowel(
                                                                                    SubstitutionCracker2.key[_i], _i)) {
                                                                                SubstitutionCracker2.key[_i] = third
                                                                                        .toLowerCase();
                                                                                SubstitutionCracker2.hasI = true;
                                                                                System.err.println(
                                                                                        "SubstitutionCracker2.hasI=true; via Scanner i_thine");
                                                                ...
                                                                if (!SubstitutionCracker2.hasI) {
                                                                    ...
                                                                    while (i_anoint.hasNext()) {
                                                                        ...
                                                                        if (next.length() == 6) {
                                                                            ...
                                                                            if (massCalc_notAnyOther(
                                                                                ...
                                                                                if (notAnotherVowel(
                                                                                        SubstitutionCracker2.key[_i],
                                                                                        _i)) {
                                                                                    SubstitutionCracker2.key[_i] = fourth
                                                                                            .toLowerCase();
                                                                                    SubstitutionCracker2.hasI = true;
                                                                                    System.err.println(
                                                                                            "SubstitutionCracker2.hasI=true; via Scanner i_anoint");
                                                                                    System.err.println((Arrays.toString(
                                                                                            SubstitutionCracker2.key))
                                                                                            .replaceAll("null",
                                                                                                    "\u0000"));
                                                                    ...
                                                                    if (!SubstitutionCracker2.hasI) {
                                                                            ...
                                                                            if (next.length() == 6) {
                                                                                ...
                                                                                if (massCalc_notAnyOther(
                                                                                    ...
                                                                                    if (notAnotherVowel(
                                                                                            SubstitutionCracker2.key[_i],
                                                                                            _i)) {
                                                                                        SubstitutionCracker2.key[_i] = first
                                                                                                .toLowerCase();
                                                                                        SubstitutionCracker2.hasI = true;
                                                                                        System.err.println(
                                                                                                "SubstitutionCracker2.hasI=true; via Scanner i_intent");
                                                                                        System.err.println((Arrays
                                                                                                .toString(
                                                                                                        SubstitutionCracker2.key))
                                                                                                .replaceAll("null",
                                                                        ...
                                                                        if (!SubstitutionCracker2.hasI) {
                                                                                ...
                                                                                if (next.length() == 4) {
                                                                                    ...
                                                                                    if (massCalc_notAnyOther(
                                                                                        ...
                                                                                        if (notAnotherVowel(
                                                                                            ...
                                                                                            SubstitutionCracker2.hasI = true;
                                                                                            System.err.println(
                                                                                                    "SubstitutionCracker2.hasI=true; via Scanner i_hint");
                                                                                            System.err.println((Arrays
                                                                                                    .toString(
                                                                                                            SubstitutionCracker2.key))
                                                                                                    .replaceAll("null",
                                                                            ...
                                                                            if (!SubstitutionCracker2.hasI) {
                                                                                i_hint.close();
                                                                                Scanner i_inn = new Scanner(
                                                                                        SubstitutionCracker2.cipher);
                                                                                while (i_inn.hasNext()) {
                                                                                    String next = i_inn.next();
                                                                                    if (next.length() == 3) {
                                                                                        String first = String.valueOf(
                                                                                                next.charAt(0));
                                                                                        ...
                                                                                        if (massCalc_notAnyOther(
                                                                                            ...
                                                                                            if (notAnotherVowel(
                                                                                                ...
                                                                                                SubstitutionCracker2.hasI = true;
                                                                                                System.err.println(
                                                                                                        "SubstitutionCracker2.hasI=true; via Scanner i_inn");
                                                                                                System.err.println(
                                                                                                        (Arrays.toString(
                                                                                                                SubstitutionCracker2.key))
                                                                                                                .replaceAll(
                                                                                ...
                                                                                if (!SubstitutionCracker2.hasI) {
                                                                                        ...
                                                                                        if (next.length() == 3) {
                                                                                            ...
                                                                                            if (massCalc_notAnyOther(
                                                                                                ...
                                                                                                if (notAnotherVowel(
                                                                                                    ...
                                                                                                    SubstitutionCracker2.hasI = true;
                                                                                                    System.err.println(
                                                                                                            "SubstitutionCracker2.hasI=true; via Scanner i_tin");
                                                                                                    System.err.println(
                                                                                                            (Arrays.toString(
                                                                                                                    SubstitutionCracker2.key))
                                                                                                                    .replaceAll(
                                                                                    ...
                                                                                    if (!SubstitutionCracker2.hasI) {
                                                                                            ...
                                                                                            if (next.length() == 4) {
                                                                                                ...
                                                                                                if (massCalc_notAnyOther(
                                                                                                    ...
                                                                                                    if (notAnotherVowel(
                                                                                                        ...
                                                                                                        System.err
                                                                                                                .println(
                                                                                                                        "SubstitutionCracker2.hasI=true; via Scanner i_tain");
                                                                                                        System.err
                                                                                                                .println(
                                                                                                                        (Arrays.toString(
                                                                                                                                SubstitutionCracker2.key))
                                                                                        ...
                                                                                        if (!SubstitutionCracker2.hasI) {
                                                                                            i_tain.close();
                                                                                            Scanner i_initiate = new Scanner(
                                                                                                    SubstitutionCracker2.cipher);
                                                                                            while (i_initiate
                                                                                                    .hasNext()) {
                                                                                                String next = i_initiate
                                                                                                        .next();
                                                                                                if (next.length() == 8) {
                                                                                                    String first = String
                                                                                                            .valueOf(
                                                                                                    ...
                                                                                                    if (first
                                                                                                        ...
                                                                                                        if (massCalc_notAnyOther(
                                                                                                            ...
                                                                                                            if (notAnotherVowel(
                                                                                                                ...
                                                                                                                System.err
                                                                                                                        .println(
                                                                                                                                "SubstitutionCracker2.hasI=true; via Scanner i_initiate");
                                                                                                                System.err
                                                                                                                        .println(
                                                                                                                                (Arrays.toString(
                                                                                                                                        SubstitutionCracker2.key))
