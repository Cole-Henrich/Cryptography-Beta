...
if(!SubstitutionCracker2.hasK){
k_attack.close();
Scanner k_hearken = new Scanner(SubstitutionCracker2.cipher);
while(k_hearken.hasNext()){
String next = k_hearken.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_h,_e,_a,_r,_e,_n})){
SubstitutionCracker2.key[_k] = fifth.toLowerCase();
SubstitutionCracker2.hasK=true;
System.err.println("SubstitutionCracker2.hasK=true; via Scanner k_hearken");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasK){
k_workers.close();
Scanner k_kitchen = new Scanner(SubstitutionCracker2.cipher);
while(k_kitchen.hasNext()){
String next = k_kitchen.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_i,_t,_c,_h,_e,_n})){
SubstitutionCracker2.key[_k] = first.toLowerCase();
SubstitutionCracker2.hasK=true;
System.err.println("SubstitutionCracker2.hasK=true; via Scanner k_kitchen");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasK){
k_weeks.close();
Scanner k_knowest = new Scanner(SubstitutionCracker2.cipher);
while(k_knowest.hasNext()){
String next = k_knowest.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh},
new int[]{_n,_o,_w,_e,_s,_t})){
SubstitutionCracker2.key[_k] = first.toLowerCase();
SubstitutionCracker2.hasK=true;
System.err.println("SubstitutionCracker2.hasK=true; via Scanner k_knowest");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
