...
if(!SubstitutionCracker2.hasB){
b_probably.close();
Scanner b_members = new Scanner(SubstitutionCracker2.cipher);
while(b_members.hasNext()){
String next = b_members.next();
if (next.length()==7){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_m,_e,_m,_e,_r,_s})){
SubstitutionCracker2.key[_b] = fourth.toLowerCase();
SubstitutionCracker2.hasB=true;
System.err.println("SubstitutionCracker2.hasB=true; via Scanner b_members");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasB){
b_bright.close();
Scanner b_bit = new Scanner(SubstitutionCracker2.cipher);
while(b_bit.hasNext()){
String next = b_bit.next();
if (next.length()==3){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
SubstitutionCracker2.key[_b] = first.toLowerCase();
SubstitutionCracker2.hasB=true;
System.err.println("SubstitutionCracker2.hasB=true; via Scanner b_bit");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasB){
b_begun.close();
Scanner b_somebody = new Scanner(SubstitutionCracker2.cipher);
while(b_somebody.hasNext()){
String next = b_somebody.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
new int[]{_s,_o,_m,_e,_o,_d,_y})){
SubstitutionCracker2.key[_b] = fifth.toLowerCase();
SubstitutionCracker2.hasB=true;
System.err.println("SubstitutionCracker2.hasB=true; via Scanner b_somebody");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasB){
b_somebody.close();
Scanner b_bought = new Scanner(SubstitutionCracker2.cipher);
while(b_bought.hasNext()){
String next = b_bought.next();
if (next.length()==6){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth},
new int[]{_o,_u,_g,_h,_t})){
SubstitutionCracker2.key[_b] = first.toLowerCase();
SubstitutionCracker2.hasB=true;
System.err.println("SubstitutionCracker2.hasB=true; via Scanner b_bought");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
...
if(!SubstitutionCracker2.hasB){
b_bought.close();
Scanner b_building = new Scanner(SubstitutionCracker2.cipher);
while(b_building.hasNext()){
String next = b_building.next();
if (next.length()==8){
String first = String.valueOf(next.charAt(0));
String second = String.valueOf(next.charAt(1));
String third = String.valueOf(next.charAt(2));
...
if(massCalc_notAnyOther(new String[]{second,third,fourth,fifth,sixth,seventh,eighth},
new int[]{_u,_i,_l,_d,_i,_n,_g})){
SubstitutionCracker2.key[_b] = first.toLowerCase();
SubstitutionCracker2.hasB=true;
System.err.println("SubstitutionCracker2.hasB=true; via Scanner b_building");
System.err.println((Arrays.toString(SubstitutionCracker2.key)).replaceAll("null", "\u0000"));
System.err.println(SubstitutionCracker2.correctKey);
